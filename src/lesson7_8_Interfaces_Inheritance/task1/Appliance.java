...
public abstract class Appliance {
    ...
    public Appliance(Home home, String location, String type, String brand, double amperage, boolean hasElectricMotor) {
        this.type = type;
        this.brand = brand;
        this.amperage = amperage;
        this.hasElectricMotor = hasElectricMotor;
        this.location = location;
        home.addAppliance(this);
    }

    public Appliance(Home home, String location, String type, String brand, double amperage, boolean hasElectricMotor, boolean isOn) {
        this.type = type;
        this.brand = brand;
        this.amperage = amperage;
        this.isOn = isOn;
