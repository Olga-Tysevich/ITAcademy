...
public class Microwave extends KitchenAppliance {
    ...
    public Microwave(Home home, String brand, double amperage, int numberOfPowerLevels, double plateDiameter) {
        super(home, "Microwave", brand, amperage, true);
        this.numberOfPowerLevels = numberOfPowerLevels;
        this.plateDiameter = plateDiameter;
    }

    public Microwave(Home home, String brand, double amperage, int numberOfPowerLevels, double plateDiameter, boolean isOn) {
        super(home, "Microwave", brand, amperage, true, isOn);
        this.numberOfPowerLevels = numberOfPowerLevels;
        this.plateDiameter = plateDiameter;
    }
