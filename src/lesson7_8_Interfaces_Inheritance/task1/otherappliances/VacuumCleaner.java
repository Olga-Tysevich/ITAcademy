...
public class VacuumCleaner extends Appliance {
    ...
    public VacuumCleaner(Home home, String location, String brand, double amperage, double dustContainerVolume) {
        super(home, location, "Vacuum cleaner", brand, amperage, true);
        this.dustContainerVolume = dustContainerVolume;
    }

    public VacuumCleaner(Home home, String location, String brand, double amperage, double dustContainerVolume, boolean isOn) {
        super(home, location, "Vacuum cleaner", brand, amperage, true, isOn);
        this.dustContainerVolume = dustContainerVolume;
    }
